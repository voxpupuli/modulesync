...
module ModuleSync
  module GitService
    ...
    class GitLab < Base
      ...
      def _open_pull_request(repo_path:, namespace:, title:, message:, source_branch:, target_branch:, labels:, noop:) # rubocop:disable Metrics/ParameterLists, Lint/UnusedMethodArgument, Layout/LineLength
        if noop
          $stdout.puts \
